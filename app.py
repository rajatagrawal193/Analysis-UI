...
from dashboards.worktime_graphs import WorktimeGraphs
...
worktime_graphs = WorktimeGraphs(default_start_date, default_end_date)
...
def display_dashboard(pathname, session_id):
    ...
    #     return major_events.content
        ...
        return sleep_pattern.content
    elif pathname == '/workout_graphs':
        return workout_graphs.content
    elif pathname == '/worktime_graphs':
        return worktime_graphs.content
    else:
        return html.Div([
